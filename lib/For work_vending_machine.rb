...
#   @drink_stock.select{| drink, price_and_stock |
...
#     elsif @drink_stock[drink_name][:stock] == 0
#       return "売り切れです。"
#     elsif @drink_stock[drink_name][:price] >= @total
#       return "お金が足りません"
#     else
...
#   def purchase(drink_name)
#     unless purchasable_drink.include?(drink_name)
#       if @drink_stock.include?(drink_name)
#         return "そのような飲み物ないので、動作しない"
#       elsif @drink_stock[drink_name][:stock] == 0 && @drink_stock[drink_name][:price] >= @total
#         return "売り切れです。お金が足りません"
#       elsif @drink_stock[drink_name][:stock] == 0
#         return "売り切れです。"
#       else
